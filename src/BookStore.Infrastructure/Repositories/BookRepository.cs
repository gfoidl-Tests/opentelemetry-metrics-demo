...
public class BookRepository : Repository<Book>, IBookRepository
{
    ...
    public BookRepository(BookStoreDbContext context, OtelMetrics meters)
        : base(context)
        => _meters = meters;
    ...
    public async Task<IEnumerable<Book>> GetBooksByCategory(int categoryId) => await this.Search(b => b.CategoryId == categoryId);
