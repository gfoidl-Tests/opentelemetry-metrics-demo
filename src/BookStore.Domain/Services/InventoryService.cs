...
public class InventoryService : IInventoryService
{
    ...
    public async Task<Inventory?> GetById(int id) => await _inventoryRepository.GetById(id);
    ...
    {
        List<Order> orders = await _orderRepository.GetOrdersByBookId(inventory.Id);
    ...
    public async Task<IEnumerable<Inventory>> SearchInventoryForBook(string bookName)
        => await _inventoryRepository.SearchInventoryForBook(bookName);
}
