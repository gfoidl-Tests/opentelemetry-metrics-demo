...
public class CategoryService : ICategoryService
{
    ...
    {
        IEnumerable<Book> books = await _bookRepository.GetBooksByCategory(category.Id);
    ...
    public async Task<IEnumerable<Category>> Search(string categoryName)
        => await _categoryRepository.Search(c => c.Name != null && c.Name.Contains(categoryName));
}
